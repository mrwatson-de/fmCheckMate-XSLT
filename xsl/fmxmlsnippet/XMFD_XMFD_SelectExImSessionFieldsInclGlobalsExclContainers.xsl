...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:date="http://exslt.org/dates-and-times" version="1.0">
	...
	Selects all normal (i.e. non-calculation and non-summary), non-container fields including global fields,
	that is, the ones that you usually want to export and/or import session data in non-fmp format.
