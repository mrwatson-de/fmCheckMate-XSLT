...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:date="http://exslt.org/dates-and-times" version="1.0">
	...
	XSL-File: XMFD_XMFD_SelectExImDataFieldsExclGlobalsInclContainers.xsl

	XML-Source: fmxmlsnippet.xml
	XML-Grammar: fmxmlsnippet
	XML-Content: copied field or table definitions
	
	Selects all normal (i.e. non-calculation and non-summary), non-global fields, including container fields,
	that is, the ones that you usually want to export and/or import stored data in fmp format.
	...
	<xsl:template match="Field[@fieldType!='Normal' or @global='True']"/>
</xsl:stylesheet>
