...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:date="http://exslt.org/dates-and-times" version="1.0">
	...
	XSL-File: XMFD_XMFD_SelectNormalFields.xsl

	XML-Source: fmxmlsnippet.xml
	XML-Grammar: fmxmlsnippet
	XML-Content: copied field or table definitions
	
	Removes the non-normal fields, leaving stored data and global fields.
	
	===== CHANGES HISTORY =====
	(c) russell@mrwatson.de 2021
	2021-08-16 MrW: Improved documentation.
	...
	<xsl:template match="Field[@fieldType!='Normal']"/>
</xsl:stylesheet>
